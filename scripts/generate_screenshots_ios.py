...
# Map original design templates to raw Fastlane snapshot filenames
SNAPSHOT_MAPPING = {
...
def build_screenshot(slide, lang, size_name, target_size):
        ...
        if not device_path:
            ...
            if os.path.exists(chk_en):
                ...
                try:
                    ...
                    print(f"Could not persist raw fallback: {e}")
    ...
    # Auto-scale font if headline > 2 lines
