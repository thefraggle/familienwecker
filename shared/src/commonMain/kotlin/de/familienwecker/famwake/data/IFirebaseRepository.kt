...
interface IFirebaseRepository {
    ...
    suspend fun leaveFamilyBatch(userId: String, familyId: String, memberId: String? = null): Result<Unit>
    ...
    suspend fun claimMember(familyId: String, memberId: String, userId: String, userName: String?, deviceId: String, force: Boolean = false): Boolean
    ...
    suspend fun updateMemberOrderAndProfiles(familyId: String, members: List<FamilyMember>)
