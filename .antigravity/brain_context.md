## Recently Completed
- [x] **Release 0.8.1:** Kritische Bugfixes für Offline-UI (Header-Priorität) und Join-Konflikt-Dialog (Race-Condition & Spinner). Deployment zu GitHub inkl. Tag `v0.8.1`.
...
- **Aktueller Stand:** Version 0.8.2-dev. Release v0.8.1 (Bugfixes) durchgeführt.
