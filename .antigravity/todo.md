...
- [x] Recently Completed (v1.3.7): Deep Link Join-Flow Fix (Navigation & Auto-Join)
- [x] Recently Completed (v1.3.7): Mitglieder-Mapping Fix, Firestore Rules Robustness, Settings UI Feedback (RELEASED)
