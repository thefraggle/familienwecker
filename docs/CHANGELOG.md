...
- **Context Menu:** Problem behoben, bei dem das native Kontextmenü (Kopieren/Einfügen) in Login-Feldern blockiert war.
- **Stabilität:** Umstellung auf stabile Semantik-Schnittstellen für Passwort-Manager.
