# 📦 Play Store Listing – FamWake (Français)
...
<b>⏱️ Conflits d'horaires ? Résolus !</b>
...
1️⃣ Crée une famille et invite tes proches avec un code d'invitation.
2️⃣ Chacun entre son temps de salle de bain, sa préférence de petit-déjeuner et son heure de départ.
3️⃣ FamWake calcule le planning parfait — automatiquement, chaque matin.

<b>Gratuit pour commencer — sans coûts cachés.</b>
Toutes les fonctionnalités essentielles de FamWake sont et resteront <b>gratuites pour toujours</b> — sans abonnement, sans piège. Des fonctionnalités premium optionnelles seront disponibles à l'avenir pour encore plus de confort. Si tu aimes déjà l'application, tu peux nous soutenir avec un petit don volontaire. ❤️

<b>Créé par un père, pour les familles.</b>
FamWake est un projet de cœur — né à notre propre table de petit-déjeuner et fait pour les familles qui veulent maîtriser leur routine matinale ensemble. Télécharge FamWake maintenant, ton nouveau réveil intelligent, et découvre à quel point un matin sans chaos peut être détendu ! 🚀

---

# 🍎 App Store Listing – FamWake (FR)

## iOS App-Name (30 Zeichen max)
FamWake Réveil Familial

## iOS Untertitel (30 Zeichen max)
Réveil familial & planning
