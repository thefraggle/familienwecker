# 📦 Play Store Listing – FamWake (Svenska)
*Senast uppdaterad: 2026-05-01*

---

## Appnamn (30 tecken max)
...
## Fullständig beskrivning (4000 tecken max)
...
<b>⏱️ Tidskonflikter? Inga problem!</b>
...
1️⃣ Skapa en familj och bjud in dina nära med en inbjudningskod.
2️⃣ Alla anger sin badrumstid, frukostönskemål och avgångstid.
3️⃣ FamWake beräknar det perfekta schemat — automatiskt, varje morgon.

<b>Gratis att börja — inga dolda kostnader.</b>
Alla kärnfunktioner i FamWake är och förblir <b>gratis för alltid</b> — inga abonnemang, inga trick. I framtiden kommer valfria premiumfunktioner för ännu mer bekvämlighet. Om du redan gillar appen kan du stödja oss med en liten frivillig donation. ❤️
...
Familjeväckare & morgonplan

## iOS Promo-Text (170 Zeichen max)
Inget mer morgonkaos! FamWake koordinerar väckningstider, badrumsvängningar och frukost för hela familjen.

## iOS Keywords (100 Zeichen max, Komma-separiert)
väckarklocka,familj,barn,morgon,rutin,badrum,planerare,alarm,snooze,organisatör