# 📦 Play Store Listing – FamWake (Italiano)
*Ultimo aggiornamento: 2026-05-01*

---

## Nome dell'app (30 caratteri max)
...
<b>⏱️ Conflitti di orario? Risolti!</b>
...
1️⃣ Crea una famiglia e invita i tuoi cari con un codice di invito.
2️⃣ Ognuno inserisce il proprio tempo in bagno, la preferenza per la colazione e l'orario di uscita.
3️⃣ FamWake calcola il programma perfetto — automaticamente, ogni mattina.

<b>Gratis per iniziare — nessun costo nascosto.</b>
Tutte le funzionalità principali di FamWake sono e rimarranno <b>gratuite per sempre</b> — nessun abbonamento, nessun trucco. In futuro saranno disponibili funzionalità premium opzionali per un comfort ancora maggiore. Se l'app ti piace già, puoi sostenerci con una piccola donazione volontaria. ❤️
