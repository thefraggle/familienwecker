...
## [0.7.4] - 2026-03-12
### Optimized
- **App Size:** Removed native debug symbols (NDK) to bring the App Bundle back under 4 MB, as embedding them provided no measurable benefit in the Play Console.
